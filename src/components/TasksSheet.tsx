...
import { ArrowLeft, Star, Users, TrendingUp, Sparkles, Coins, Gift, CheckCircle2, Trophy, Zap, Target, Award, Flame, Crown, BarChart2 } from "lucide-react";
import { toast } from "@/hooks/use-toast";
import { TaskProgressBar } from "@/components/ui/TaskProgressBar";

// tasks definition (30 items)
export const surveyTasks = [
  {
    id: 1,
    title: "Join Site Survey",
    description: "Complete a quick site survey & earn rewards",
    link: "https://crn77.com/4/10676426",
    reward: "+₦5,000",
    badge: "HOT",
    icon: Star,
  ...
  },
  {
    ...
    description: "Share your opinion and earn extra rewards",
    link: "https://omg10.com/4/10575212",
    reward: "+₦5,000",
    badge: "HOT",
    icon: Star,
  ...
  },
  {
    ...
    description: "Rate our services and get rewarded instantly",
    link: "https://omg10.com/4/10575212",
    reward: "+₦5,000",
    badge: "EARN",
    icon: TrendingUp,
  ...
  },
  {
    ...
    description: "Tell us how we can serve you better",
    link: "https://spin-to-win-hub-6676aed7-phi.vercel.app/",
    reward: "+₦5,000",
    badge: "EASY",
    icon: Sparkles,
  ...
  },
  {
    ...
    description: "Complete during weekends for bonus rewards",
    link: "https://crn77.com/4/10676426",
    reward: "+₦5,000",
    badge: "DAILY",
    icon: Coins,
  ...
  {
    id: 11,
    title: "Trust Score Survey",
    description: "Build your trust score & boost your earnings",
    link: "https://crn77.com/4/10676426",
    reward: "+₦5,000",
    badge: "HOT",
    icon: Trophy,
    iconBg: "linear-gradient(135deg, hsl(45,100%,51%), hsl(35,100%,50%))",
    bgFrom: "hsla(45,100%,51%,0.06)",
    bgTo: "hsla(35,100%,50%,0.04)",
    borderColor: "hsla(45,100%,51%,0.2)",
    badgeBg: "hsla(45,100%,51%,0.2)",
    badgeColor: "hsl(45,100%,51%)",
  },
  {
    id: 12,
    title: "Flash Reward Task",
    description: "Limited time task — grab your bonus now",
    link: "https://omg10.com/4/10575212",
    reward: "+₦5,000",
    badge: "FLASH",
    icon: Zap,
    iconBg: "linear-gradient(135deg, hsl(55,100%,55%), hsl(35,100%,50%))",
    bgFrom: "hsla(55,100%,55%,0.06)",
    bgTo: "hsla(35,100%,50%,0.04)",
    borderColor: "hsla(55,100%,55%,0.2)",
    badgeBg: "hsla(55,100%,55%,0.2)",
    badgeColor: "hsl(55,100%,55%)",
  },
  {
    id: 13,
    title: "Platform Audit Survey",
    description: "Help audit our platform and earn big",
    link: "https://crn77.com/4/10676426",
    reward: "+₦5,000",
    badge: "EARN",
    icon: Target,
    iconBg: "linear-gradient(135deg, hsl(0,90%,60%), hsl(340,80%,55%))",
    bgFrom: "hsla(0,90%,60%,0.06)",
    bgTo: "hsla(340,80%,55%,0.04)",
    borderColor: "hsla(0,90%,60%,0.2)",
    badgeBg: "hsla(0,90%,60%,0.2)",
    badgeColor: "hsl(0,90%,60%)",
  },
  {
    id: 14,
    title: "Achievement Unlock Task",
    description: "Unlock a special achievement badge",
    link: "https://omg10.com/4/10575212",
    reward: "+₦5,000",
    badge: "NEW",
    icon: Award,
    iconBg: "linear-gradient(135deg, hsl(289,100%,65%), hsl(220,80%,60%))",
    bgFrom: "hsla(289,100%,65%,0.06)",
    bgTo: "hsla(220,80%,60%,0.04)",
    borderColor: "hsla(289,100%,65%,0.2)",
    badgeBg: "hsla(289,100%,65%,0.2)",
    badgeColor: "hsl(289,100%,65%)",
  },
  {
    id: 15,
    title: "Streak Bonus Survey",
    description: "Keep your streak alive and earn extra",
    link: "https://spin-to-win-hub-6676aed7-phi.vercel.app/",
    reward: "+₦5,000",
    badge: "HOT",
    icon: Flame,
    iconBg: "linear-gradient(135deg, hsl(15,100%,55%), hsl(35,100%,50%))",
    bgFrom: "hsla(15,100%,55%,0.06)",
    bgTo: "hsla(35,100%,50%,0.04)",
    borderColor: "hsla(15,100%,55%,0.2)",
    badgeBg: "hsla(15,100%,55%,0.2)",
    badgeColor: "hsl(15,100%,55%)",
  },
  {
    id: 16,
    title: "VIP Access Survey",
    description: "Unlock VIP status with this premium task",
    link: "https://crn77.com/4/10676426",
    reward: "+₦5,000",
    badge: "VIP",
    icon: Crown,
    iconBg: "linear-gradient(135deg, hsl(45,100%,51%), hsl(262,76%,57%))",
    bgFrom: "hsla(45,100%,51%,0.06)",
    bgTo: "hsla(262,76%,57%,0.04)",
    borderColor: "hsla(45,100%,51%,0.2)",
    badgeBg: "hsla(262,76%,57%,0.2)",
  ...
  {
    id: 17,
    title: "Growth Metrics Task",
    description: "Share growth metrics & earn top rewards",
    link: "https://omg10.com/4/10575212",
    reward: "+₦5,000",
    badge: "EARN",
    icon: BarChart2,
    iconBg: "linear-gradient(135deg, hsl(174,88%,56%), hsl(220,80%,60%))",
    bgFrom: "hsla(174,88%,56%,0.06)",
    bgTo: "hsla(220,80%,60%,0.04)",
    borderColor: "hsla(174,88%,56%,0.2)",
    badgeBg: "hsla(174,88%,56%,0.2)",
  ...
  {
    id: 18,
    title: "Partner Survey Task",
    description: "Complete partner survey and get bonus coins",
    link: "https://crn77.com/4/10676426",
    reward: "+₦5,000",
    badge: "DAILY",
    icon: Users,
    iconBg: "linear-gradient(135deg, hsl(200,90%,55%), hsl(174,88%,56%))",
    bgFrom: "hsla(200,90%,55%,0.06)",
    bgTo: "hsla(174,88%,56%,0.04)",
    borderColor: "hsla(200,90%,55%,0.2)",
    badgeBg: "hsla(200,90%,55%,0.2)",
    badgeColor: "hsl(200,90%,55%)",
  },
  {
    id: 19,
    title: "Loyalty Points Survey",
    description: "Earn loyalty points on top of cash rewards",
    link: "https://spin-to-win-hub-6676aed7-phi.vercel.app/",
    reward: "+₦5,000",
    badge: "EASY",
    icon: Star,
    iconBg: "linear-gradient(135deg, hsl(55,100%,55%), hsl(45,100%,51%))",
    bgFrom: "hsla(55,100%,55%,0.06)",
    bgTo: "hsla(45,100%,51%,0.04)",
    borderColor: "hsla(55,100%,55%,0.2)",
    badgeBg: "hsla(55,100%,55%,0.2)",
  ...
  {
    id: 20,
    title: "Milestone 20 Challenge",
    description: "Halfway there! Complete this milestone task",
    link: "https://omg10.com/4/10575212",
    reward: "+₦5,000",
    badge: "BONUS",
    icon: Trophy,
    iconBg: "linear-gradient(135deg, hsl(174,88%,56%), hsl(45,100%,51%))",
    bgFrom: "hsla(174,88%,56%,0.1)",
    bgTo: "hsla(45,100%,51%,0.06)",
    borderColor: "hsla(174,88%,56%,0.3)",
    badgeBg: "hsla(174,88%,56%,0.2)",
    badgeColor: "hsl(174,88%,56%)",
  },
  {
    ...
    description: "Share your insights and get rewarded",
    link: "https://crn77.com/4/10676426",
    reward: "+₦5,000",
    badge: "NEW",
    icon: Sparkles,
    iconBg: "linear-gradient(135deg, hsl(289,100%,65%), hsl(174,88%,56%))",
    bgFrom: "hsla(289,100%,65%,0.06)",
    bgTo: "hsla(174,88%,56%,0.04)",
    borderColor: "hsla(289,100%,65%,0.2)",
    badgeBg: "hsla(289,100%,65%,0.2)",
  ...
  },
  {
    ...
    description: "Rate & review our app for instant reward",
    link: "https://omg10.com/4/10575212",
    reward: "+₦5,000",
    badge: "EASY",
    icon: Star,
    iconBg: "linear-gradient(135deg, hsl(45,100%,51%), hsl(55,100%,55%))",
    bgFrom: "hsla(45,100%,51%,0.06)",
    bgTo: "hsla(55,100%,55%,0.04)",
    borderColor: "hsla(45,100%,51%,0.2)",
    badgeBg: "hsla(45,100%,51%,0.2)",
    badgeColor: "hsl(45,100%,51%)",
  },
  {
    id: 23,
    title: "Trend Analysis Survey",
    description: "Help analyze trends and earn your reward",
    link: "https://spin-to-win-hub-6676aed7-phi.vercel.app/",
    reward: "+₦5,000",
    badge: "EARN",
    icon: TrendingUp,
    iconBg: "linear-gradient(135deg, hsl(262,76%,57%), hsl(200,90%,55%))",
    bgFrom: "hsla(262,76%,57%,0.06)",
    bgTo: "hsla(200,90%,55%,0.04)",
    borderColor: "hsla(262,76%,57%,0.2)",
    badgeBg: "hsla(262,76%,57%,0.2)",
    badgeColor: "hsl(262,76%,57%)",
  },
  {
    id: 24,
    title: "Premium Daily Task",
    description: "Premium daily challenge with top payout",
    link: "https://crn77.com/4/10676426",
    reward: "+₦5,000",
    badge: "HOT",
    icon: Zap,
    iconBg: "linear-gradient(135deg, hsl(15,100%,55%), hsl(262,76%,57%))",
    bgFrom: "hsla(15,100%,55%,0.06)",
    bgTo: "hsla(262,76%,57%,0.04)",
    borderColor: "hsla(15,100%,55%,0.2)",
    badgeBg: "hsla(15,100%,55%,0.2)",
  ...
  {
    id: 25,
    title: "Engagement Boost Task",
    description: "Boost your engagement score & earn more",
    link: "https://omg10.com/4/10575212",
    reward: "+₦5,000",
    badge: "DAILY",
    icon: Flame,
    iconBg: "linear-gradient(135deg, hsl(35,100%,55%), hsl(15,100%,55%))",
    bgFrom: "hsla(35,100%,55%,0.06)",
    bgTo: "hsla(15,100%,55%,0.04)",
    borderColor: "hsla(35,100%,55%,0.2)",
    badgeBg: "hsla(35,100%,55%,0.2)",
    badgeColor: "hsl(35,100%,55%)",
  },
  {
    ...
    description: "Expand your network & collect your reward",
    link: "https://crn77.com/4/10676426",
    reward: "+₦5,000",
    badge: "NEW",
    icon: Users,
    iconBg: "linear-gradient(135deg, hsl(220,80%,60%), hsl(262,76%,57%))",
    bgFrom: "hsla(220,80%,60%,0.06)",
    bgTo: "hsla(262,76%,57%,0.04)",
    borderColor: "hsla(220,80%,60%,0.2)",
    badgeBg: "hsla(220,80%,60%,0.2)",
    badgeColor: "hsl(220,80%,60%)",
  },
  {
    id: 27,
    title: "Impact Score Survey",
    description: "Measure your impact and earn triple rewards",
    link: "https://spin-to-win-hub-6676aed7-phi.vercel.app/",
    reward: "+₦5,000",
    badge: "EARN",
    icon: Target,
    iconBg: "linear-gradient(135deg, hsl(174,88%,56%), hsl(262,76%,57%))",
    bgFrom: "hsla(174,88%,56%,0.06)",
    bgTo: "hsla(262,76%,57%,0.04)",
    borderColor: "hsla(174,88%,56%,0.2)",
    badgeBg: "hsla(174,88%,56%,0.2)",
  ...
  {
    id: 28,
    title: "Champion League Task",
    description: "Enter the champion league for massive bonuses",
    link: "https://omg10.com/4/10575212",
    reward: "+₦5,000",
    badge: "VIP",
    icon: Crown,
    iconBg: "linear-gradient(135deg, hsl(45,100%,51%), hsl(35,100%,50%))",
    bgFrom: "hsla(45,100%,51%,0.08)",
    bgTo: "hsla(35,100%,50%,0.05)",
    borderColor: "hsla(45,100%,51%,0.25)",
    badgeBg: "hsla(45,100%,51%,0.2)",
    badgeColor: "hsl(45,100%,51%)",
  },
  {
    id: 29,
    title: "Legacy Reward Survey",
    description: "One step away — complete your legacy task",
    link: "https://spin-to-win-hub-6676aed7-phi.vercel.app/",
    reward: "+₦5,000",
    badge: "HOT",
    icon: Award,
    iconBg: "linear-gradient(135deg, hsl(289,100%,65%), hsl(45,100%,51%))",
    bgFrom: "hsla(289,100%,65%,0.08)",
    bgTo: "hsla(45,100%,51%,0.05)",
    borderColor: "hsla(289,100%,65%,0.25)",
    badgeBg: "hsla(289,100%,65%,0.2)",
    badgeColor: "hsl(289,100%,65%)",
  },
  {
    id: 30,
    title: "🏆 Final Unlock Task",
    description: "Complete task 30 to UNLOCK withdrawal!",
    link: "https://spin-to-win-hub-6676aed7-phi.vercel.app/",
    reward: "+₦5,000",
    badge: "FINAL",
    icon: Trophy,
    iconBg: "linear-gradient(135deg, hsl(45,100%,51%), hsl(174,88%,56%), hsl(262,76%,57%))",
    bgFrom: "hsla(45,100%,51%,0.12)",
    bgTo: "hsla(174,88%,56%,0.08)",
    borderColor: "hsla(45,100%,51%,0.4)",
    badgeBg: "hsla(45,100%,51%,0.3)",
    badgeColor: "hsl(45,100%,51%)",
  },
];
  ...
  return (
    <div className="hh-task-root fixed inset-0 z-50 flex flex-col overflow-hidden">
      ...
      <header className="relative z-10 hh-task-header-nav px-4 py-4 flex items-center gap-3 border-b border-white/5">
        ...
        <div className="flex items-center gap-2">
          <span className="text-[10px] text-emerald-400 font-medium bg-emerald-500/10 px-2 py-1 rounded-full border border-emerald-500/20">
            {completedTasks.length}/{surveyTasks.length} Done
          </span>
          {activeTaskId !== null && (
      ...
      <div className="relative z-10 px-4 pt-4 pb-2">
        <TaskProgressBar completed={completedTasks.length} total={surveyTasks.length} />
      </div>
